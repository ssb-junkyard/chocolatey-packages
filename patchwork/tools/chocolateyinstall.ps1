...
$url        = 'https://github.com/ssbc/patchwork/releases/download/v3.17.2/Patchwork-Setup-3.17.2.exe' # download url, HTTPS preferred
$url64      = 'https://github.com/ssbc/patchwork/releases/download/v3.17.2/Patchwork-Setup-3.17.2.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'patchwork*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'F738B3E2BB0926D2A26EECBB70F4B890'
  checksumType  = 'md5' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = 'F738B3E2BB0926D2A26EECBB70F4B890'
